...
weapon = [augmentedironworksbow, zetabow]
head = [yaahkirimuhat, demonhat, aironhat, dreadhat]
body = [yaahkirimuchest, aironworkschest, dreadchest, demonchest]
hands = [yaahkirimugloves, airongloves, demongloves, dreadgloves]
waist = [yaaharachnesash, aironbelt, demonbelt, dreadbelt]
legs = [yaahkirimupants, demonpants, aironpants, dreadpants]
feet = [yaahkirimufeet, aironfeet, dreadfeet, demonfeet]
necklace = [aironchoak, dreadchoak]
earrings = [yaahplatear, aironearings, dreadear]
