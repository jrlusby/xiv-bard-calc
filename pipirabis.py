...
Head = [ Midan_Goggles_of_Aiming2, Augmented_Torrent_Mask_of_Aiming0, ]
...
Feet = [ Midan_Boots_of_Aiming0, Augmented_Torrent_Boots_of_Aiming1, ]
...
Ring = [ Midan_Ring_of_Aiming1, Augmented_Primal_Ring_of_Aiming1, ]
